...
class PatientAllTransactions extends StatefulWidget {
  PatientAllTransactions(this.scafcontext,
      {super.key, required this.teamCode, required this.name});
  String teamCode;
  BuildContext scafcontext;
  String name;

  @override
  State<PatientAllTransactions> createState() => _PatientAllTransactionsState();
}

class _PatientAllTransactionsState extends State<PatientAllTransactions> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("All Transactions of ${widget.name}"),
      ),
